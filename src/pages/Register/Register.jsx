  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      confirm_password: Yup.string()
        .oneOf([Yup.ref("matKhau")], "Mật khẩu không trùng khớp với mật khẩu trên!")
        .required("Không được bỏ trống!"),
      soDt: Yup.string()
        ...
        <div className='sm:grid lg:grid grid-cols-2'>
          <div className="flex -mx-3 mr-2">
            <div className="w-full px-3 mb-5">
              <label htmlFor className="text-xs font-semibold px-1">Tài khoảng</label>
              <div className="flex">
                ...
                <input type="text" name='taiKhoan' onChange={formik.handleChange} className="w-full -ml-10 pl-3 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Nhập tài khoảng" />
              </div>
          ...
          <div className="flex -mx-3 mr-2">
            <div className="w-full px-3 mb-5">
              ...
              <div className="flex">
                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg" /></div>
                <input name='confirm_password' onChange={formik.handleChange} type="password" className="w-full -ml-10 pl-3 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Nhập lại mật khẩu trên" />
          ...
          <div className="flex -mx-3">
            <div className="w-full px-3 mb-5">
              ...
              <div className="flex">
                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg" /></div>
                <input type="text" name='hoTen' onChange={formik.handleChange} className="w-full -ml-10 pl-3 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="nguyenvana@gmail.com" />
          ...
          <div className="flex -mx-3 mr-2">
            <div className="w-full px-3 mb-5">
              ...
              <div className="flex">
                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg" /></div>
                <input type="email" name='email' onChange={formik.handleChange} className="w-full -ml-10 pl-3 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="nguyenvana@gmail.com" />
