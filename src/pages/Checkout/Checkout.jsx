            ...
            <table className="border-collapse border border-slate-500">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border px-2 border-slate-700 ...">
                    <span className="text-xl text-green-500">
                      Ghế đang chọn bởi bạn( Click lần 1 để chọn, lần 2 để xóa )
                    </span>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="border px-2 border-slate-700 ...">
                    <span className="text-xl text-yellow-500">
                      Ghế đã đặt bởi tài khoảng của bạn
                    </span>
                  </td>
                </tr>
              </tbody>
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-blue-500">
              LƯU Ý: Xem kĩ thông tin về thời gian và địa điểm xem phim, tránh
              nhầm lẫn vì chúng tôi không khuyến khích việc đổi lại vé! Xin chân
              thành cảm ơn quý khách! (Đùa thôi, chứ quý khách là thượng đế ạ
              ^_^!)
            </p>
          </div>
